...
// 액션 타입 정의
const GET_USERS_START = "/redux-start/users/GET_USERS_START"; // 깃헙 api 호출
const GET_USERS_SUCCESS = "/redux-start/users/GET_USERS_SUCCESS"; // 깃헙 api 호출에 대한 응답이 성공
const GET_USERS_FAIL = "/redux-start/users/GET_USERS_FAIL"; // 깃헙 api 호출에 대한 응답이 실패
